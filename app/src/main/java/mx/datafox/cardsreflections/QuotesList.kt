...
val quotes = arrayOf(
    ...
    Quote(
        "Creen en ti",
        "Un individuo seguro -que conoce su identidad y cree en ella, lleva consigo herramientas en lugar de armas. No necesita quedar por encima de los demás. Cuando crees de verdad -en ti, en tus ideas-, no te sientes amenzado, sino seguro.",
        "Amy Cuddy",
        "El poder de la presencia",
        R.drawable.imagen13,
        R.drawable.cuddy
